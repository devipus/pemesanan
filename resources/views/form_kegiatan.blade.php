<div class="modal" id="modal-form" tabindex="1" role="dialog" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="form-kegiatan" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-md-3 control-label">Kegiatan</label>
                        <div class="col-md-6">
                            <input type="text" id="kegiatan" name="kegiatan" class="form-control" autofocus required>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>

                    <div class="form-group">
                      <label for="" class="col-md-3 control-label">Tanggal Mulai</label>
                      <div class="col-md-6">
                          <input data-dateRange1="#tglmulai" type="text" id="tglmulai" name="tglmulai" class="form-control datepicker" required>
                          <span class="help-block with-errors"></span>
                      </div>
                    </div>

                    <div class="form-group">
                      <label for="" class="col-md-3 control-label">Tanggal Selesai</label>
                      <div class="col-md-6">
                          <input data-dateRange2 type="text" id="tglselesai" name="tglselesai" class="form-control datepicker" required>
                          <span class="help-block with-errors"></span>
                      </div>
                    </div>
                    <div class="form-group">
