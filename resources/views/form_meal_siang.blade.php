            ...
            <div class="row">
              ...
              <div class="row" style="text-align:center; padding:4px;">
                    <div class="col-md-4" style="text-align:center; padding:20px">
                     ...
                     <div class="col-md-4 " style="text-align:center; padding:20px">
                           <h3 class="text-center   btn-default"> Lembur</h3>
                    </div>
                </div>  
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                      ...
                      <label for="" class="col-md-4 control-label">Staf</label>
                      <div class="col-md-8">
                          <input type="text" id="ss_lembur" name="ss_lembur" class="form-control" >
                          <span class="help-block with-errors"></span>
                      </div>
                    </div>
                      <div class="form-group">
                      <label for="" class="col-md-4 control-label">Non Staf</label>
                      <div class="col-md-8">
                          <input type="text" id="ns_lembur" name="ns_lembur" class="form-control" >
                          <span class="help-block with-errors"></span>
                      </div>
                    </div>
                      <div class="form-group">
                      <label for="" class="col-md-4 control-label">Tkno</label>
                      <div class="col-md-8">
                          <input type="text" id="tkno_lembur" name="tkno_lembur" class="form-control" >
                          <span class="help-block with-errors"></span>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="" class="col-md-4 control-label">Tamu</label>
                      <div class="col-md-8">
                          <input type="text" id="tamu_lembur" name="tamu_lembur" class="form-control" >
                          <span class="help-block with-errors"></span>
                      </div>
                    </div>
